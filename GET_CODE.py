...
#Please input your Key.key without any space.
...
def Making_URL():
    ...
    if word == -1:
        Error()
    URL = "https://opendict.korean.go.kr/api/search?certkey_no=575&key=" + key + "&target_type=search&part=word&q=" + word + "&sort=dict&start=1&num=10"
